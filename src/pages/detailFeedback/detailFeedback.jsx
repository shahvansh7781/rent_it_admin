...
import { EmailOutlined, Message } from '@mui/icons-material'
      ...
      <div className='userContainer'>
        <div className='userShow'>
          ...
          <div className='userShowBottom'>
            ...
            <span className='userShowTitle'>Feedback Message</span>
            <div className='userShowInfo'>
              <Message className='userShowIcon' />
              <span className='userShowInfoTitle'>Hello World</span>
            </div>
          </div>
        </div>
      </div>
